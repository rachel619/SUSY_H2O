...
```
Among all the LR models. lambda = 0.0 will give largest auc for the validation dataset. The final choosen LR model has auc = 0.834163 on test data set.


```{r LR-ROC, echo = FALSE}
plot(h2o.performance(model_LR, SUSY_train))
...
GBM_grid <- h2o.grid("gbm",x = x, y = y, training_frame = SUSY_train, 
                 ...
                 search_criteria = list(strategy = "Cartesian"),
                  stopping_tolerance = 0.001,stopping_rounds = 3, 
                 score_tree_interval = 10, ntrees = 100
)
