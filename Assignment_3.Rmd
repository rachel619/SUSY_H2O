...
Eight models tested. The highest auc is 0.8604350414577883, with max_depth = 20, mtries = 3, ntrees =50.
...
s2
```
The final RF model gives auc = 0.8577427 on test data.
...
The final model has a auc = 0.857742684585674.
...
```
Notice: Need to take a further look at the GBM (ROC curve).